...
- Created noble shares the recipient's **culture and religion**, so they are truly local
...
- Changes the checksum, so **no achievements** can be earned with this mod active
